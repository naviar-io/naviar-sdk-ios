...
final class RequestBodyCreator {
    ...
    func addToBody(photo: UploadVPSPhoto, metaKey: String, imageKey: String = "", featuresKey: String = "", locationIds: [String]) {
        let params = getParams(from: photo, locationIds: locationIds)
    ...
    func getParams(from photo: UploadVPSPhoto, locationIds: [String]) -> [String: Any] {
        ...
        let intrinsics = ["fx": photo.instrinsicsFX,
                          ...
                          "width": photo.width,
                          "height": photo.height] as [String : Any]
        var attributes = ["client_coordinate_system": photo.locationClientCoordSystem,
                          ...
                          "location_ids": locationIds] as [String : Any]
        if !location.isEmpty {
            attributes["location"] = location
        }
        let data = ["attributes": attributes] as [String : Any]
