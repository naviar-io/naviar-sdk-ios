...
public struct Settings {
    ...
    let url: String
    /// Ids of locations for multilocation localization
    ...
    /// Max fails to reset session id
    let maxFailsCount: Int
    ...
    public init(url: String = "https://vps.naviar.io/",
                locationIds: [String],
                recognizeType: RecognizeType,
                maxFailsCount: Int = 5,
                neuroLinkmnv: String = "https://mobile-weights.naviar.io/mnv_960x540x1_4096.tflite",
                neuroLinkmsp: String = "https://mobile-weights.naviar.io/msp_960x540x1_256_400.tflite",
        ...
        self.maxFailsCount = maxFailsCount
    }
}
...
public struct ResponseVPSPhoto {
    ...
    ///   - posPitch: pitch
    ///   - posYaw: yaw
    public init(status: Bool, statusDescription: String, vpsPose: VPSPose? = nil, vpsSendPose: VPSPose? = nil, gps: GPSResponse? = nil, compass: CompassResponse? = nil, locationId: String? = nil) {
        self.status = status
